...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/07/24 17:08:21 by mailinci          #+#    #+#             */
/*   Updated: 2025/07/24 17:08:25 by mailinci         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	resize_buffer(t_heredoc_buffer *buffer, size_t new_capacity)
{
	...
	new_content = safe_alloc(new_capacity, sizeof(char), \
								"heredoc resized buffer");
	if (!new_content)
		return (1);
